# -*- coding: utf-8 -*-
################################################################################
# Делкарация ast узлов логических формул, реализация бета-редукции (ванина лекция, где ты?)
# определение множества свободных переменных и других операций над деревом
# AST Nodes
